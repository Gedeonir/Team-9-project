...
export default function Card() {
  return (
    <a href="#" className="relative block group my-4 hover:">
        <img
        ...
        <div className="absolute h-48 bottom-0 left-0 right-0 flex flex-col items-start justify-end p-6 bg-gray-100 bg-opacity-50">
